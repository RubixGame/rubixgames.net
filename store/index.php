...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="wrapper">
                <div class="recc store">
                    <div class="reccomendation store__item">
                        <h class="item__name">Hi<?php?></h>
                        <p class="item__bio">Hi<?php?></p>
                        <p class="item__price">&dollar;<?php?></p>                       
                    </div>
                </div>
            </div>
        </div>
